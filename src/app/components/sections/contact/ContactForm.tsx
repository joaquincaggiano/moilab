...
const ContactForm = () => {
  ...
  return (
    <div className='group relative w-full max-w-xl h-auto xl:h-[80svh] xl:max-h-[580px]'>
      {/* Holographic overlay */}
      ...
      <form
        action={action}
        className='relative h-full bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-3xl p-6 flex flex-col gap-6 xl:justify-between border border-gray-700/30 group-hover:border-gray-600/50 transition-all duration-700'
      >
